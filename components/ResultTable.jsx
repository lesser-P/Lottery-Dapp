    ...
    <>
      <div className=' py-10 px-5 bg-slate-100'>
        <div className={'flex flex-col items-center justify-center text-center py-10'}>
          <h4 className=' text-4xl text-slate-600 text-center font-bold pb-3'>Lottery Result</h4>
          ...
          <p className=' text-sm text-gray-500 w-full sm:w-2/3'>
            Result for {``}
            <span className=' font-medium text-green-600'>{result?.winners?.length} winners </span>
            out of{' '}
